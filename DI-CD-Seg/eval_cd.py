...
def main():
    ...
    parser.add_argument('--checkpoints_root', default='./20241127_bs32_Orange_seg2_P2_orange_N5_adamw_linear_nums2_442', type=str)
    ...
    parser.add_argument('--net_G', default='Orange_seg2_P2_orange', type=str,
                        help='ELGCNet|orange_densely|orange2_C3|Orange_seg2_P2_orange')
